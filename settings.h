...
MidiCode midiInputs[NUM_INPUTS] = {
  ...
  { LOW_CONTROL,     true },    // up arrow pad
  { LOW_CONTROL + 1, true },    // down arrow pad
  { LOW_NOTE + 6,    false },   // left arrow pad   (PALM/WRIST HIT)
  { LOW_CONTROL + 3, true },    // right arrow pad
  { LOW_CONTROL + 4, true },    // space button pad
  { LOW_CONTROL + 2, true },    // click button pad


  // female header on the back left side

  { LOW_NOTE,     false },      // pin D5
  { LOW_NOTE + 1, false },      // pin D4
  { LOW_NOTE + 2, false },      // pin D3
  { LOW_NOTE + 3, false },      // pin D2
  { LOW_NOTE + 4, false },      // pin D1
  { LOW_NOTE + 5, false },      // pin D0


  // female header on the back right side

  { LOW_CONTROL + 5, true },    // pin A5
  { LOW_CONTROL + 6, true },    // pin A4
  { LOW_CONTROL + 7, true },    // pin A3
  { LOW_CONTROL + 8, true },    // pin A2
  { LOW_CONTROL + 9, true },    // pin A1
  { LOW_CONTROL + 10, true }    // pin A0
};
